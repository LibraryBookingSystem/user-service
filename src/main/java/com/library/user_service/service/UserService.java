...
public class UserService {
    ...
    public UserResponse validateCredentials(ValidateCredentialsRequest request) {
        ...
        if (user.isPendingApproval()) {
            throw new InvalidCredentialsException("Your account is pending approval. Please wait for an administrator or faculty member to approve your registration.");
        }
        
        // Check if user is rejected
        if (user.isRejected()) {
            throw new InvalidCredentialsException("Your account registration was rejected. Please contact an administrator.");
        }
